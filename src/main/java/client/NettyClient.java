        ...
        new Thread(() -> {
            while (!Thread.interrupted()) {
                if (!SessionUtil.hasLogin(channel)) {
                    ...
                    if (toUserId.equals(SessionUtil.getSession(channel).getUserId()) && message.equals("logout")){
                        // 注销操作
                        System.out.println("  log out === "+SessionUtil.hasLogin(channel)+";toUserId:"+toUserId+","+SessionUtil.getSession(channel).getUserId());
